...
import edu.cmu.pocketsphinx.demo.ui.gallery.GalleryFragment
import edu.cmu.pocketsphinx.demo.ui.send.SendFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController.addOnDestinationChangedListener {
            ...
            if (destination.label == "Voice Report") {
                var intent = Intent(this, PocketSphinxActivity::class.java)
    ...
    fun reportBtn1Click(view: View) {
        // Get the text fragment instance
        val textFragment = SendFragment()
        ...
        transaction.replace(R.id.nav_view,textFragment)
        transaction.addToBackStack(null)

        // Finishing the transition
        transaction.commit()
    }
    fun reportBtn2Click(view: View) {
        var intent = Intent(this, PocketSphinxActivity::class.java)
        startActivity(intent)
